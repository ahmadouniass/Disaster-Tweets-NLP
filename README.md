...
Chaque expérience a été tracée avec **MLflow**.

### Le Champion : BERT-base-uncased (Fine-tuned)
Après comparaison de plus de 20 modèles, c'est **BERT-base** qui a été sélectionné pour sa performance supérieure.
...
Le **F1-Score** a été retenu comme métrique principale pour équilibrer la détection des alertes réelles (Rappel) et la limitation des fausses alertes (Précision).
